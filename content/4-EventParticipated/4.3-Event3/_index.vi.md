...
FCAJ Community Day là một sự kiện mang tính cộng đồng, kết nối các bạn thực tập sinh với những diễn giả giàu kinh nghiệm trong các lĩnh vực Cloud, DevOps và Generative AI. Sự kiện giúp người tham dự hiểu thêm về văn hóa công ty, định hướng kỹ thuật và lộ trình phát triển nghề nghiệp, đồng thời tiếp cận với những cách làm thực tế đang được áp dụng trong ngành cloud hiện đại.

Đối với em, sự kiện này rất giá trị vì không chỉ cho thấy công nghệ nào đang được sử dụng, mà còn giúp em hiểu cách một tổ chức công nghệ thực sự suy nghĩ về thiết kế sản phẩm, khả năng mở rộng nền tảng, vận hành AI và năng suất của lập trình viên.

### Nội Dung Nổi Bật

#### 1. TymeX’s Secret Sauce: From SaaS to SaaP
Một trong những phần gây ấn tượng nhất với em là cách TymeX tiếp cận việc phát triển sản phẩm. Thay vì chỉ tập trung vào SaaS, các diễn giả giới thiệu tư duy SaaP, tức là Software as a Product/Platform.
...
Phần thảo luận về bảo vệ workload tại edge, tối ưu chi phí và tăng hiệu quả cho các workload động giúp em thấy CloudFront là một thành phần nền tảng của kiến trúc cloud hiện đại chứ không phải chỉ là một lớp tối ưu phụ trợ.

### Những Gì Học Được

Từ FCAJ Community Day, em rút ra được nhiều bài học quan trọng:

- phát triển theo tư duy platform-centric có khả năng tái sử dụng và mở rộng tốt hơn;
- Platform Engineering là cầu nối quan trọng giữa team sản phẩm và team hạ tầng;
- ứng dụng AI cũng cần kỷ luật vận hành, observability và kế hoạch hạ tầng rõ ràng;
- AI Agent đang thay đổi quy trình phát triển phần mềm;
- chiến lược edge là một phần cốt lõi của thiết kế bảo mật và hiệu năng.
...
FCAJ Community Day là một trong những sự kiện có giá trị nhất mà em từng tham gia vì sự kiện kết nối được văn hóa công ty, thực hành kỹ thuật hiện đại và định hướng tương lai của phát triển dựa trên cloud. Sự kiện giúp em hiểu rõ hơn cách Cloud, DevOps và Generative AI đang hội tụ thành một hệ sinh thái thực tiễn, đồng thời tạo thêm động lực để em tiếp tục học tập theo định hướng này.
