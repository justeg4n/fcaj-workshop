...
| --- | --- | --- | --- | --- |
| 2 | - Setup S3 Backend for Terraform State.<br>- Add DynamoDB table for state locking to prevent concurrent apply issues. | 03/02/2026 | 03/02/2026 |  |
| 3 | - Write Python Lambda function (`ingestion_trigger.py`) to process S3 `ObjectCreated` events. | 03/03/2026 | 03/03/2026 |  |
| 4 | - Complete the Serverless Bookstore architecture lab.<br>- Use API Gateway to trigger Lambda. | 03/04/2026 | 03/04/2026 |  |
| 5 | - Design DynamoDB Schema (Single-table design).<br>- Create `Partition Key` (PK) and `Sort Key` (SK) for flexible queries. | 03/05/2026 | 03/05/2026 |  |
