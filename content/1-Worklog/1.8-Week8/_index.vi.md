...
| --- | --- | --- | --- | --- |
| 2 | - Cài Terraform CLI.<br>- Khởi tạo `main.tf` tạo VPC và Security Group. | 02/23/2026 | 02/23/2026 |  |
| 3 | - Kickoff SmartHireAI: Lên ý tưởng kiến trúc "Split-Brain" (State bằng .NET, AI bằng Python Lambda). | 02/24/2026 | 02/24/2026 | |
| 4 | - Chia module Terraform (`vpc.tf`, `variables.tf`).<br>- Chạy `terraform apply` thử nghiệm. | 02/25/2026 | 02/25/2026 |  |
| 5 | - Phân tích ECS và EKS.<br>- Quyết định dùng ECS Fargate cho API .NET để giảm thiểu quản trị node. | 02/26/2026 | 02/26/2026 |  |
| 6 | - Viết code Terraform cho Auto Scaling.<br>- Đẩy source code Terraform lên GitHub team. | 02/27/2026 | 02/27/2026 |  |
