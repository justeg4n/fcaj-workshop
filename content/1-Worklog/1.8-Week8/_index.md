...
| --- | --- | --- | --- | --- |
| 2 | - Install Terraform CLI.<br>- Write `main.tf` to provision basic VPC and Security Groups. | 02/23/2026 | 02/23/2026 |  |
...
| 4 | - Modularize Terraform code (`vpc.tf`, `variables.tf`, `outputs.tf`).<br>- Use `terraform plan` and `terraform apply`. | 02/25/2026 | 02/25/2026 |  |
| 5 | - Research Orchestration: ECS Fargate vs EKS.<br>- Decide on Fargate for the SmartHireAI .NET API to minimize node management. | 02/26/2026 | 02/26/2026 |  |
| 6 | - Setup Auto Scaling policies via Terraform.<br>- Version control Terraform code in GitHub. | 02/27/2026 | 02/27/2026 |  |
